...
- Estimated variance components, heritability, and genetic correlations via REML/AI-REML, and validated genomic prediction accuracy using an LR temporal validation framework
...
**Quantitative genetics / genomic prediction:** Single-step GBLUP (ssGBLUP) and GBLUP via BLUPF90+/GIBBSF90+, including threshold models for binary traits; univariate, bivariate, and multi-trait mixed-model analyses; REML/AI-REML variance component estimation; LR validation; genomic relationship matrix construction (VanRaden method); weighted/evidence-informed genomic prediction
