...
PhD student in Statistical Genetics specializing in quantitative genetics and genomic prediction across animal and plant breeding systems. Experienced in single-step GBLUP, mixed-model genetic evaluation, and cross-species genomic prediction informed by transcriptomic evidence. Background in plant pathology and disease-resistance breeding, with three years of industry experience evaluating crop disease resistance within a commercial trait-advancement pipeline.
...
- Estimated variance components, heritability, and genetic correlations via REML/AI-REML, and validated genomic prediction accuracy using the LR (Legarra & Reverter, 2018) temporal validation framework
...
**Quantitative genetics / genomic prediction:** Single-step GBLUP (ssGBLUP) and GBLUP via BLUPF90+/GIBBSF90+, including threshold models for binary traits; univariate, bivariate, and multi-trait mixed-model analyses; REML/AI-REML variance component estimation; LR (Legarra & Reverter, 2018) validation; genomic relationship matrix construction (VanRaden method); weighted/evidence-informed genomic prediction
